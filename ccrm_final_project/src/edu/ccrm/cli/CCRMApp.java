...
import java.util.*;import java.nio.file.*;
 ...
 /** CCRMApp CLI (Author: Ananjay Goyal) */
public class CCRMApp {
    ...
    public static void main(String[]args)throws Exception{
        ...
        System.out.println("Goodbye - Ananjay Goyal");
    }

    private static void seed(){
        studentService.addStudent(new Student("1","24BCE11438","Ananjay Goyal","ananjay.24bce11438@vitbhopal.ac.in"));
        courseService.addCourse(new Course.Builder().code("CS101").title("Intro to CS").credits(4).instructor("Dr. Sharma").semester(Semester.SPRING).department("CS").build());
    }
